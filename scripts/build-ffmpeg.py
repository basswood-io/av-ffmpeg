...
library_group = [
    ...
    Package(
        name="xml2",
        source_url="https://download.gnome.org/sources/libxml2/2.13/libxml2-2.13.8.tar.xz",
...
codec_group = [
    ...
    Package(
        name="png",
        source_url="https://downloads.sourceforge.net/project/libpng/libpng16/1.6.48/libpng-1.6.48.tar.xz",
...
def main():
    ...
    if "nasm" not in available_tools and platform.machine() not in {"arm64", "aarch64"}:
        build_tools.append(
            Package(
                name="nasm",
                source_url="https://web.archive.org/web/20250211082910/https://www.nasm.us/pub/nasm/releasebuilds/2.16.03/nasm-2.16.03.tar.xz",
